...
import WebsitesImg from './website.png'
  ...
  render() {
    return (
      <Section className="BGwhite" style={{ marginTop:"0rem" }}>
        ...
        <PortfolioContainer>
          <Project img={RavenImg} title="GRUPO PROYECTAR" role="UI/UX Designer" Button="/GrupoProyectar" />
          ...
          <Project img={WebsitesImg} title="WEBSITE DESIGN" role="Web Designer" Button="/WebsitesDetails" />

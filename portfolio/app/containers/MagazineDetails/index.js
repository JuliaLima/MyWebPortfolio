...
export class MagazineDetails extends React.Component { // eslint-disable-line react/prefer-stateless-function
  render() {
    ...
    return (
      <ProjectDetailsLayout title="MAGAZINE" prevProject="ReySolDetails" nextProject="SocialClubDetails">
        <ProjectsDescription
          img={Magazine}
          ...
          stepTitle={Process}
          ProcessParagraph="Establishment of a grid and definition of spaces for texts and images. The graphic elements and chromatic palette used refer to the IT world, lines and squares and range of blues."
          images={ImagesArray}
